<title>Услуга "Работа в Польше" от компании WorkLeader | Работа в Европейских странах</title>
...
<div class="container">
  ...
  <div class="row">
    <div class="col l6 s12">
      <img style="width:100%;" src="/public/images/services/JobInPol/glek.png" alt="glek">
    </div>
    <div class="col l6 s12">
  ...
  <div class="row">
    <table class="striped responsive-table">
      ...
      <tbody>
        ...
        <tr>
          <td>Трудоустройство по биометрическому паспорту</td>
          <td>1500грн</td>
          <td>7-14 дней</td>
          <td>Биометрический паспорт + страховка</td>
        </tr>
        <tr>
          <td>Оформления полного пакета документа+страховка (180/180, 180/360)</td>
          <td>3500грн</td>
          <td>4-5 недель</td>
          <td>Заграничный паспорт, зражданский паспорт</td>
        </tr>
        <tr>
          <td>Оформления годового разрешения (Воеводское приглашение)+страховка</td>
          <td>250 евро</td>
          <td>6-8 недель</td>
          <td>Заграничный паспорт, зражданский паспорт</td>
        </tr>
        <tr>
          <td>Помощь в оформлении карты побыта (1-3 года)</td>
          <td>750 евро</td>
          <td>1-7 дней</td>
          <td>Уточнять дополнительно</td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  <div class="swiper-container">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        <div class="row feedback" style="margin:0; padding:0">
          <div id="maskTop" class="mask"></div><div id="maskBottom" class="mask"></div>
          <div class="col s12" style="margin:0; padding:0">
            <p style="margin:0; padding:0">
              <img id="reviewsImg" src="/public/images/review/3.jpg">
              <p><span>Сергей Терещенко</span><span style="position:absolute; right:0;">20.03.18</span></p>
              <span style="max-height:100px; text-overflow: ellipsis;">
                Уехал через Ворк Лидер в Чехию. До этого метался по работам в Киеве. За границей раньше не был. 
      ...
      <div class="swiper-slide">
        <div class="row feedback" style="margin:0; padding:0">
          ...
          <div class="col s12" style="margin:0; padding:0">
            <p style="margin:0; padding:0">
              <img id="reviewsImg" src="/public/images/review/1.jpg">
              <p><span>Владимир Иванов</span><span style="position:absolute; right:0;">10.01.19</span></p>
              <span>
      ...
      <div class="swiper-slide">
        <div class="row feedback" style="margin:0; padding:0">
          ...
          <div class="col s12" style="margin:0; padding:0">
            <p style="margin:0; padding:0">
              <img id="reviewsImg" src="/public/images/review/2.png">
              <p><span>Наталья Явлинская</span><span style="position:absolute; right:0;">13.09.18</span></p>
              <span>
