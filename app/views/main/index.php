...
<script type="text/javascript">var hellopreloader = document.getElementById("hellopreloader_preload");function fadeOutnojquery(el){el.style.opacity = 1;var interhellopreloader = setInterval(function(){el.style.opacity = el.style.opacity - 0.05;if (el.style.opacity <=0.05){ clearInterval(interhellopreloader);hellopreloader.style.display = "none";}},16);}window.onload = function(){setTimeout(function(){fadeOutnojquery(hellopreloader);},1500);};</script> -->
  ...
  <div class="carousel carousel-slider banner">
  ...
  <div class="container">
    <div class="section scrollspy" id="why-we">
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center brown-text"><i class="fas fa-user-tie"></i></h2>
            <h5 class="center">Большой опыт работы</h5>
          </div>
        </div>
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center brown-text"><i class="fas fa-users"></i></h2>
            <h5 class="center">Индивидуальный подход к каждому клиенту</h5>
          </div>
        </div>
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center brown-text"><i class="far fa-clock"></i></h2>
            <h5 class="center">Кратчайшие сроки</h5>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center brown-text"><i class="fas fa-hands-helping"></i></h2>
            <h5 class="center">Заключение договора</h5>
          </div>
        </div>
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center brown-text"><i class="fas fa-headset"></i></h2>
            <h5 class="center">24/7 консультация специалистов</h5>
          </div>
        </div>
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center brown-text"><i class="fas fa-user-friends"></i></h2>
            <h5 class="center">Поддержка на весь период трудоустройства</h5>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="icon-block">
            <h2 class="center brown-text"><i class="fas fa-truck"></i></h2>
            <h5 class="center">Бесплатная доставка документов</h5>
          </div>
        </div>
        <div class="col s12 m6">
          <div class="icon-block">
            <h2 class="center brown-text"><i class="fas fa-clipboard-check"></i></h2>
            <h5 class="center">Подбор самых выгодных условий для соискателей </h5>
          </div>
        </div>
      </div>
    </div>
